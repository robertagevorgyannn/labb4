#!/usr/bin/env python3
"""
интерфейс для управления телефонной книгой (PostgreSQL версия)
Это консольная программа, которая реализует программное взаимодействие с БД для вставки, изменения, удаления и поиска контактов
"""
